			...
			?>
				<div class="logo_container">
					...
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<h1 style="color:white;" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>"><?php echo esc_attr( get_bloginfo( 'name' ) ); ?></h1>
					</a>
				</div>
			<?php
